...
DATASETS = {
    ...
    'crowd_train': {
        IM_DIR:
            _DATA_DIR + '/crowd/images',
        ANN_FN:
            _DATA_DIR + '/crowd/annotations/kibr_14_train.json'
    },
    'crowd_val': {
        IM_DIR:
            _DATA_DIR + '/crowd/images',
        ANN_FN:
            _DATA_DIR + '/crowd/annotations/kibr_14_val.json'
    },
    'crowd_test': {
        IM_DIR:
            _DATA_DIR + '/crowd/images',
        ANN_FN:
            _DATA_DIR + '/crowd/annotations/kibr_14_test.json'
    }
}
